...
import { courses_get, add_course_post, delete_course, update_course_patch, add_slot_post, delete_slot, update_slot_patch, course_slots_get, course_slots_get_by_day } from "../controllers/appController";
...
router.get("/slots/:day", course_slots_get_by_day);
